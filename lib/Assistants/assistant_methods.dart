...
class AssistantMethods {
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    double localCurrencyTotalFare = totalFareAmount * 133;

    if(driverVehicleType == "Saha-Bahan"){
      double resultFareAmount = ((localCurrencyTotalFare.truncate()) * 2);
      print("resultFareAmount Saha-Bahan: ${resultFareAmount}");
      return resultFareAmount;
    }
    else if(driverVehicleType == "Air Ambulance"){
      double resultFareAmount = ((localCurrencyTotalFare.truncate()) * 15);
      print("resultFareAmount Air Ambulance: ${resultFareAmount}");
      return resultFareAmount;
    }
    else if(driverVehicleType == "Ambulance"){
      double resultFareAmount = ((localCurrencyTotalFare.truncate()) * 1);
      print("resultFareAmount Ambulance: ${resultFareAmount}");
      return resultFareAmount;
    }
    else{
